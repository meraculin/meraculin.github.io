...
To get this spring constant, we can use the power spectrum analysis of the position of the trapped droplet, which is usually considered to be the most reliable 
