...
categories: analysis
---
Beads or droplets trapped in the optical tweezers are subjected to the viscous resistance of the solution and the elastic force of the optical tweezers. Furthermore, if the external force is expressed as $$ F(t) $$, the equation of motion of the beads is given by the Langevin equation:
