...
<div class="col-sm mt-3 mt-md-0">
    {% include figure.html path="assets/img/20230504_position.png" class="img-fluid rounded z-depth-1" %}
</div>
...
```
<div class="col-sm mt-3 mt-md-0">
    {% include figure.html path="assets/img/20230504_spectrogram.png" class="img-fluid rounded z-depth-1" %}
</div>
...
```
<div class="col-sm mt-3 mt-md-0">
    {% include figure.html path="assets/img/20230504_psd.png" class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="col-sm mt-3 mt-md-0">
    {% include figure.html path="assets/img/20230504_psd_fit.png" class="img-fluid rounded z-depth-1" %}
</div>