...
Then, now we can apply <a href = "https://imagej.net/imaging/particle-analysis">welch</a> function to get the power spectrum (nm<sup>2</sup>) of the droplets. The video is taken in 800 FPS, so the Nyquist frequency (bandwidth) is 800 Hz.
