...
Then, now we can apply signal.welch function to get the power spectral density of the droplets
...
<div class="caption">
    <strong>Figure 2.</strong> Power spectral density of the droplets again
</div>
### Under construction