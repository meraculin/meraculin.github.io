...
Then, now we can apply signal.welch function to get the power spectrum ($$ nm^2 $$) of the droplets. The video is taken in 800 FPS, so the Nyquist frequency (bandwidth) is 800 Hz.
